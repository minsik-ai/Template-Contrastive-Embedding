...
class SimCSE(object):
    ...
    def __init__(self, model_name_or_path: str, 
                ...
                pooler = None):
        if pooler == "pad_left_no_pooler":
            print("Pad Left No Pooler Initialization")
            self.tokenizer = AutoTokenizer.from_pretrained(model_name_or_path, padding_size="left")
        else:
    ...
    def encode(self, sentence: Union[str, List[str]], 
        ...
        with torch.no_grad():
            ...
            for batch_id in tqdm(range(total_batch)):
                ...
                elif self.pooler == "pad_left_no_pooler":
