...
PATH_TO_SENTEVAL = '/home/ec2-user/workspaces/semantic-similarity/src/Python-senteval/'

# Import SentEval
# sys.path.insert(0, PATH_TO_SENTEVAL)
PATH_TO_DATA = '/home/ec2-user/data'
...
class CLTrainer(Trainer):
    ...
    def evaluate(
        ...
        if not self.args.eval_transfer:
            PATH_TO_DATA = self.args.evaluation_data
        ...
        elif self.args.eval_rephrase:
            tasks = ['Rephrase']
        self.model.eval()
        results = se.eval(tasks)

        if not self.args.eval_rephrase:
            stsb_spearman = results['STSBenchmark']['dev']['spearman']
            sickr_spearman = results['SICKRelatedness']['dev']['spearman']
            ...
            rephrase_auc = results['Rephrase']['dev']['auc']
            metrics = {"eval_rephrase_auc": rephrase_auc}
